    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="{{ route('project-create') }}" class="text-decoration-none"><button class="nav-link">Add
                    project</button></a>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View project</button>
            </li>
        </ul>
                            ...
                            <tr class=" text-center">
                                ...
                                <td>
                                    <div class="container-fluid d-flex">
                                        ...
                                        <a class="mx-2" href="{{route('project-edit',$project)}}">
                                            <div class="btn blue_button sized"><i
                                                    class='bx bx-message-square-edit'></i><small>edit</small>
                                            </div>
                                        </a>
                                        <a class="mx-2" href="{{route('project-delete',$project)}}">
                ...
                <div class="row px-3 pb-3 justify-content-end">
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none" href="{{ $projects->withQueryString()->previousPageUrl() }}">
                            ...
                            <a class="text-decoration-none" href="{{ $projects->withQueryString()->nextPageUrl() }}">
