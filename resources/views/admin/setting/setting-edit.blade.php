        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            {{-- <li class="nav-item" role="presentation">
                <button class="nav-link active" id="unpaid-tab" data-bs-toggle="tab" data-bs-target="#unpaid" type="button"
                    role="tab" aria-controls="unpaid" aria-selected="true">Add setting Settings</button>
            </li> --}}
            <a href="{{ route('setting-index') }}" class="text-decoration-none"><button class="nav-link">View
                    Setting Section Settings</button></a>
        </ul>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" name="site_name" class="form-control" id="site_name"
                                    placeholder="Orginization site_name" value="{{ old('site_name', $setting->site_name) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                @if ($errors->has('site_logo'))
                                    <div class="error text-danger">{{ $errors->first('site_logo', $setting->site_logo) }}
                                    </div>
                                @endif
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="site_alt_text" class="form-control" id="site_alt_text"
                                    placeholder="Orginization site_alt_text" value="{{ old('site_alt_text', $setting->site_alt_text) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" name="instagram_link" class="form-control" id="instagram_link"
                                    placeholder="Instagram link" value="{{ old('instagram_link', $setting->instagram_link) }}">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" name="facebook_link" class="form-control" id="facebook_link"
                                    placeholder="Facebook link" value="{{ old('facebook_link', $setting->facebook_link) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" name="twitter_link" class="form-control" id="twitter_link"
                                    placeholder="Twitter link" value="{{ old('twitter_link', $setting->twitter_link) }}">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" name="linkedin_link" class="form-control" id="linkedin_link"
                                    placeholder="Linkedin link" value="{{ old('linkedin_link', $setting->linkedin_link) }}">
