...
@section('content')
    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <a href="{{ route('banner-index') }}" class="text-decoration-none"><button class="nav-link">View
                    Banner Section Settings</button></a>
        </ul>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control" id="title"
                                    placeholder="Branch title" value="{{ old('title', $banner->title) }}">
                                @if ($errors->has('title'))
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="description" class="form-control" id="description"
                                    placeholder="Branch description" value="{{ old('description', $banner->description) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="alt_text" class="form-control" id="alt_text"
                                    placeholder="Branch alt_text" value="{{ old('alt_text', $banner->alt_text) }}">
