    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="{{ route('banner-create') }}" class="text-decoration-none"><button class="nav-link">Add
                    Banner</button></a>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View Banner</button>
            </li>
        </ul>
                            ...
                            <tr class=" text-center">
                                ...
                                <td>
                                    <div class="container-fluid d-flex">
                                        ...
                                        <a class="mx-2" href="{{route('banner-edit',$banner)}}">
                                            <div class="btn blue_button sized"><i
                                                    class='bx bx-message-square-edit'></i>edit
                                            </div>
                                        </a>
                                        <a class="mx-2" href="{{route('banner-delete',$banner)}}">
                ...
                <div class="row px-3 pb-3 justify-content-end">
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none" href="{{ $banners->withQueryString()->previousPageUrl() }}">
                            ...
                            <a class="text-decoration-none" href="{{ $banners->withQueryString()->nextPageUrl() }}">
...
@section('footer')
    <script>
        ...
        function go() {
            ...
            const url = new URL("{{ url('/') }}/banner-index");
