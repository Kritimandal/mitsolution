        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View Post</button>
            </li>
        </ul>
                ...
                <div class="row px-3 pb-3 justify-content-end">
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none" href="{{ $posts->withQueryString()->previousPageUrl() }}">
                            ...
                            <a class="text-decoration-none" href="{{ $posts->withQueryString()->nextPageUrl() }}">
...
@section('footer')
    <script>
        ...
        function go() {
            ...
            const url = new URL("{{ url('/') }}/post-index");
