                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control" id="title"
                                    placeholder="Branch title" value="{{ old('title', $post->title) }}">
                                @if ($errors->has('title'))
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" name="priority" class="form-control" id="priority"
                                    placeholder="priority" value="{{ old('priority', $post->priority) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="alt_text" class="form-control" id="alt_text"
                                    placeholder="Branch alt_text" value="{{ old('alt_text',$post->alt_text) }}">
