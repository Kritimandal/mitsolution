    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="{{ route('testimonial-create') }}" class="text-decoration-none"><button class="nav-link">Add
                        Testimonial</button></a>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View testimonial</button>
            </li>
        </ul>
                    ...
                    <table class="table" style="width: 100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-light" style="background-color: #515151">Rating
                                </th>
                        ...
                        <tbody>
                            ...
                            @foreach ($testimonials as $key => $testimonial)
                                <tr class=" text-center">
                                    ...
                                    <td scope="row">{{ $testimonial->content }}</td>
                                    <td scope="row">{{ $testimonial->rating }}</td>
                                    <td><img src="{{ asset('images/photos/' . $testimonial->image) }}"
                                            alt="{{ $testimonial->alt_text }}" height="100" width="100"></td>

                                    <td>
                                        <div class="container-fluid d-flex">


                                            <a class="mx-2" href="{{ route('testimonial-edit', $testimonial) }}">
                                                <div class="btn blue_button sized"><i
                                                        class='bx bx-message-square-edit'></i>edit
                                                </div>
                                            </a>
                                            <a class="mx-2" href="{{ route('testimonial-delete', $testimonial) }}">
                    ...
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none"
                                href="{{ $testimonials->withQueryString()->previousPageUrl() }}">
                            ...
                            <a class="text-decoration-none" href="{{ $testimonials->withQueryString()->nextPageUrl() }}">
...
@section('footer')
    <script>
        ...
        function go() {
            ...
            const url = new URL("{{ url('/') }}/testimonial-index");
