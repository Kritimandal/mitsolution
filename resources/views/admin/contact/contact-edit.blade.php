        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            {{-- <li class="nav-item" role="presentation">
                <button class="nav-link active" id="unpaid-tab" data-bs-toggle="tab" data-bs-target="#unpaid" type="button"
                    role="tab" aria-controls="unpaid" aria-selected="true">Add customer Settings</button>
            </li> --}}
            <a href="{{ route('customer-index') }}" class="text-decoration-none"><button class="nav-link">View
                    Customer Section Settings</button></a>
        </ul>
