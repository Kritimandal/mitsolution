        ...
        <div class="tab-content py-2 navsTabsShadow" id="myTabContent">
            ...
            <div class="tab-pane fade show  active" id="unpaid" role="tabpanel" aria-labelledby="unpaid-tab">
                <div class="container-fluid p-3">
                    <form method="POST" action="{{ route('subcategory-update',$subCategory) }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                    placeholder="Branch Name" value="{{ old('name', $subCategory->name) }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="description" class="form-control" id="description"
                                    placeholder="Branch description" value="{{ old('description', $subCategory->description) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="alt_text" class="form-control" id="alt_text"
                                    placeholder="Branch alt_text" value="{{ old('alt_text', $subCategory->alt_text) }}">
