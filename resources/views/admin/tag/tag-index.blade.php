    ...
    <div class="px-2 px-md-4">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="{{ route('tag-create') }}" class="text-decoration-none"><button class="nav-link">Add
                        tag</button></a>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="paid-tab" data-bs-toggle="tab" data-bs-target="#paid" type="button"
                    role="tab" aria-controls="paid" aria-selected="false">View tag</button>
            </li>
        </ul>
                                ...
                                <tr class=" text-center">
                                    ...
                                    <td scope="row">
                                        <div class="container-fluid justify-content-between">
                                            ...
                                            <a class="mx-2" href="{{ route('tag-edit', $tag) }}">
                                                <div class="btn blue_button sized"><i
                                                        class='bx bx-message-square-edit'></i>edit
                                                </div>
                                            </a>
                                            <a class="mx-2" href="{{ route('tag-delete', $tag) }}">
                ...
                <div class="row px-3 pb-3 justify-content-end">
                    <div class="col-7 d-flex justify-content-end">
                        <div class="d-flex p-0 m-0">
                            <a class="text-decoration-none" href="{{ $tags->withQueryString()->previousPageUrl() }}">
                            ...
                            <a class="text-decoration-none" href="{{ $tags->withQueryString()->nextPageUrl() }}">
